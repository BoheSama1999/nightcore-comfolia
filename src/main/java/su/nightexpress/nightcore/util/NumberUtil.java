...
//        var compact = getCompact(value);
//        return Pair.of(format(compact.getValue()), compact.getShortcut() == null ? "" : compact.getShortcut().getSymbol());
...
//        int step = CoreConfig.NUMBER_STEP.get();
//        int index = 0;
